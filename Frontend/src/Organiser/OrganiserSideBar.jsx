    ...
    <div className="flex flex-col h-screen bg-gradient-to-br from-purple-50 to-indigo-50">
      <div className="flex flex-1 overflow-hidden">
        ...
        <motion.div
          ...
          className={`fixed top-0 left-0 h-full bg-gradient-to-b from-purple-800 to-indigo-900 text-gray-100 p-4 z-40 shadow-2xl overflow-hidden`}
        >
        ...
        <main className={`flex-1 p-6 ${isMobile ? '' : !isOpen ? 'ml-20' : 'ml-64'} transition-all duration-300 flex flex-col`}>
