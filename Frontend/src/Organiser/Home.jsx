      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500">Growth over the last 6 months</p>
          </div>
          <span className="px-3 py-1 text-sm bg-blue-100 text-blue-600 rounded-full">+18%</span>
        </div>

        {/* Bar Graph-style Section */}
        <div className="mt-12 space-y-4">
          <h3 className="text-xl font-semibold text-gray-800">Submissions Over Time</h3>
          <div className="h-48 flex items-end gap-3">
            {[
              ...
              <div key={bar.label} className="flex flex-col items-center justify-end w-8">
                <div
                  className="w-full bg-[#3B82F6] rounded-t-xl"
                  style={{ height: `${bar.value * 1.5}px` }}
                ></div>
                <span className="mt-2 text-xs text-gray-500">{bar.label}</span>
              </div>
            ))}
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="flex justify-center">
              <div className="relative w-44 h-44">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-3xl font-bold text-[#3B82F6]">75%</span>
                  <span className="text-sm text-gray-500">Judging Completed</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between bg-[#F9FAFB] p-4 rounded-xl shadow">
                ...
                <p className="font-semibold text-[#3B82F6]">324</p>
              </div>
              <div className="flex items-center justify-between bg-[#F9FAFB] p-4 rounded-xl shadow">
