        ...
        <div className="max-w-6xl mx-auto px-6 py-12 relative z-10">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 px-4 py-2 rounded-full text-sm font-medium flex items-center">
              ...
              Team Size: {hackathon.teamSize?.min ?? "?"}-
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-5">
                        <DetailItem
                          ...
                          value={hackathon.collegeName}
                        />
                        <DetailItem
                          icon="📍"
                          label="Location"
                          value={hackathon.collegeAddress}
                        />
                        <DetailItem
                          icon="🖥"
                          label="Mode"
                        ...
                        <DetailItem
                          icon="👥"
                          label="Team Size"
                          value={`${hackathon.teamSize.min} - ${hackathon.teamSize.max} members`}
                        />
                      </div>
                        ...
                        <div className="p-6 space-y-4">
                          ...
                          <div className="flex items-center">
                            ...
                            <div>
                              ...
                              <p className="font-medium">
                                {hackathon.contactDetails.email}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center">
                            ...
                            <div>
                              ...
                              <p className="font-medium">
                                {hackathon.contactDetails.phone}
                              </p>
                            </div>
                          </div>
                        </div>
