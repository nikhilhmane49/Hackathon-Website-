...
// // //    const fetchInfo = () => {
// // //      const hackathondetail = Hackton.find((hac) => hac._id === hackathon_id);
// // //      setHackathon(hackathondetail);
// // //   };
  
// // //     useEffect(() => {
// // //       fetchInfo();
// // //     }, [hackathon_id, Hackton]);
...
// // //                 <img
// // //                   src={Hackton.logo}
// // //                   alt={`${Hackton.hackathonName} Logo`}
// // //                   className="w-16 h-16 object-contain"
// // //                 />
// // //               </div>
// // //               <div>
// // //                 <h1 className="text-3xl md:text-4xl font-extrabold">
// // //                   {Hackton.hackathonName}
// // //                 </h1>
// // //                 <h3 className="text-xl text-indigo-200 mt-1">
// // //                   {Hackton.collegeName}
// // //                 </h3>
// // //               </div>
// // //             </div>
...
// // //                   Total Prize Pool
// // //                 </p>
// // //                 <p className="text-2xl font-bold">{Hackton.prizePool}</p>
// // //               </div>
// // //             </motion.div>
// // //           </div>
...
// // //               {Hackton.mode.charAt(0).toUpperCase() + Hackton.mode.slice(1)}{" "}
// // //               Hackathon
// // //             </div>
...
// // //                 />
// // //               </svg>
// // //               Team Size: {Hackton.teamSize.min}-{Hackton.teamSize.max}
// // //             </div>
// // //           </div>
// // //         </div>
// // //       </div>
...
// // //                   {["stages", "prizes", "details", "rules", "contact"].map(
// // //                     (tab) => (
// // //                       <button
// // //                         key={tab}
...
// // //                         {Hackton.stages.map((stage, index) => (
// // //                           <motion.div
// // //                             key={index}
...
// // //                                 {formatDate(stage.timeline.startDate)} to{" "}
// // //                                 {formatDate(stage.timeline.endDate)}
// // //                               </div>
// // //                             </div>
// // //                           </motion.div>
// // //                         ))}
...
// // //                           <path
// // //                             fillRule="evenodd"
// // //                             d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm4 5V6a4 4 0 00-8 0v1h8zm-3 2a1 1 0 10-2 0v2a1 1 0 102 0V9z"
// // //                             clipRule="evenodd"
// // //                           />
// // //                         </svg>
// // //                       </div>
...
// // //                       {Hackton.winners.prizes.map((prize, index) => (
// // //                         <motion.div
// // //                           key={index}
...
// // //                         {Hackton.highlights.map((highlight, index) => (
...
// // //                           value={Hackton.collegeName}
// // //                         />
// // //                         <DetailItem
// // //                           icon="📍"
// // //                           label="Location"
// // //                           value={Hackton.collegeAddress}
// // //                         />
// // //                         <DetailItem
// // //                           icon="🖥️"
// // //                           label="Mode"
// // //                           value={
// // //                             Hackton.mode.charAt(0).toUpperCase() +
// // //                             Hackton.mode.slice(1)
// // //                           }
// // //                         />
// // //                         <DetailItem
// // //                           icon="👥"
// // //                           label="Team Size"
// // //                           value={`${Hackton.teamSize.min} - ${Hackton.teamSize.max} members`}
// // //                         />
// // //                       </div>
...
// // //                           icon="🏆"
// // //                           label="Prize Pool"
// // //                           value={Hackton.prizePool}
// // //                         />
// // //                         <DetailItem
// // //                           icon="📅"
// // //                           label="Registration Period"
// // //                           value={`${formatDate(
// // //                             Hackton.registration.startDate
// // //                           )} to ${formatDate(Hackton.registration.endDate)}`}
// // //                         />
// // //                         <DetailItem
// // //                           icon="🌎"
// // //                           label="Countries Represented"
// // //                           value={Hackton.stats.countries.toString()}
// // //                         />
// // //                         <DetailItem
// // //                           icon="🤝"
// // //                           label="Industry Partners"
// // //                           value={Hackton.stats.partners.toString()}
// // //                         />
// // //                       </div>
// // //                     </div>
...
// // //                       <p className="text-gray-600 mb-4">
// // //                         To ensure a fair and productive event for all
// // //                         participants, please adhere to the following rules:
// // //                       </p>
...
// // //                             <p className="mt-1">
// // //                               Violation of any of these rules may result in
// // //                               disqualification. The judges' decision is final in
// // //                               all matters.
// // //                             </p>
// // //                           </div>
// // //                         </div>
...
// // //                     value={Hackton.stats.registered}
// // //                     color="bg-blue-50"
...
// // //                     icon="👁️"
// // //                     label="Page Views"
// // //                     value={Hackton.stats.impressions.toLocaleString()}
// // //                     color="bg-purple-50"
...
// // //                     value={formatDate(Hackton.registration.endDate)}
// // //                     color="bg-red-50"
...
// // //                   {
// // //                     icon: "💡",
// // //                     text: "Develop innovative solutions to real-world problems",
// // //                   },
// // //                   {
// // //                     icon: "🚀",
// // //                     text: "Launch your career with industry recognition",
// // //                   },
// // //                   {
// // //                     icon: "🌐",
// // //                     text: "Network with tech leaders and innovators",
// // //                   },
...
// // //                   Top-performing teams will be invited to exclusive mentorship
// // //                   programs and potential internship opportunities with our
// // //                   sponsor companies.
// // //                 </p>
// // //               </div>
// // //             </div>
...
// // import { Appcontext } from "../context/contextpra";
// // import { useParams } from "react-router-dom";
// // import Confetti from 'react-confetti'; // Assuming you have a Confetti component or package
...
// //       const timer = setInterval(() => {
// //         const now = new Date();
// //         const targetDate = new Date(Hackton.registration.endDate);
// //         const difference = targetDate - now;
...
// //               Registration closing in:
// //             </p>
// //             <div className="flex space-x-4 text-lg font-semibold text-indigo-600">
// //               <div className="flex flex-col items-center">
...
// //                     <strong>Task:</strong> {stage.participantTask}
// //                   </p>
...
// //                     {formatDate(stage.timeline.startDate)} –{" "}
// //                     {formatDate(stage.timeline.endDate)}
// //                   </p>
// //                 </div>
// //               ))}
...
// //                 <strong>Name:</strong> {Hackton?.contactDetails?.name}
// //               </p>
// //               <p className="text-gray-700">
// //                 <strong>Email:</strong> {Hackton?.contactDetails?.email}
// //               </p>
// //               <p className="text-gray-700">
// //                 <strong>Phone:</strong> {Hackton?.contactDetails?.phone}
// //               </p>
// //             </div>
// //           )}
// //         </div>
...
// const { hackathon, listhackton, backendurl, token, settoken } =
// //     useContext(Appcontext);
// //   console.log(Hackton);
// //   const { hackathon_id } = useParams();
...
//                         <DetailItem icon="🖥" label="Mode" value={hackathon.mode.charAt(0).toUpperCase() + hackathon.mode.slice(1)} />
...
function HackathonInfo() {
  ...
  const fetchInfo = () => {
    ...
    if (hackathondetail) {
      ...
      const timer = setInterval(() => {
        const now = new Date();
        const targetDate = new Date(hackathondetail.registration.endDate);
        const difference = targetDate - now;
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center mb-6 md:mb-0">
              <div className="bg-white p-3 rounded-xl mr-6 shadow-lg">
                <img
                  src={hackathon?.logo}
                  alt={`${hackathon?.hackathonName} Logo`}
                  className="w-16 h-16 object-contain"
                />
              </div>
              <div>
        ...
        <div className="mt-6">
          ...
          {activeTab === "contact" && (
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                <strong>Name:</strong> {hackathon?.contactDetails?.name}
              </p>
              <p className="text-gray-700">
                <strong>Email:</strong> {hackathon?.contactDetails?.email}
              </p>
              <p className="text-gray-700">
                <strong>Phone:</strong> {hackathon?.contactDetails?.phone}
              </p>
            </div>
          )}
        </div>
