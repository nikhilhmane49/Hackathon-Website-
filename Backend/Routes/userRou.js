...
const { regester, userlogin, updateProfile , applyToHackathon,getprofile,saveTeamReg,getTeamReg } = require('../Contorell/Usercon.js');
...
userroutes.get('/user-getteam', authuser, getTeamReg);
